...
@interface Everlag : NSObject

@end

@implementation Everlag
...
CHConstructor // code block that runs immediately upon load
{
	...
	// this would be posted using: notify_post("com.arichardson.Everlag.eventname");
	CFNotificationCenterRef darwin = CFNotificationCenterGetDarwinNotifyCenter();
	CFNotificationCenterAddObserver(darwin, NULL, ExternallyPostedNotification, CFSTR("com.arichardson.Everlag.eventname"), NULL, CFNotificationSuspensionBehaviorCoalesce);
